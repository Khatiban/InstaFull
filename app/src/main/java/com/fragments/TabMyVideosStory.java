...
import com.adapters.MySavedVideosAdapter_Story;
import com.adapters.MySavedVideosAdapter_Story.onItemClickListener;
import com.adapters.MySavedVideosAdapter_Story.onItemLongClickListener;
import com.adapters.SpacesItemDecoration_Story;
import com.fury.instafull.CreatedVideoActivity_Story;
...
public class TabMyVideosStory extends Fragment implements onItemClickListener, onItemLongClickListener {
    public static TabMyVideosStory tabVideos;
    private boolean doCut;
    String filePath;
    private boolean isSelecting;
    ArrayList<DownloadModel_Story> items;
    private MySavedVideosAdapter_Story mAdapter;
    Context mContext;
    Menu menu;
    ...
    class C04062 extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (f.listFiles() != null) {
                for (File path : f.listFiles(new C04051())) {
                    items.add(new DownloadModel_Story(path.getAbsolutePath()));
                }
            }
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            mAdapter = new MySavedVideosAdapter_Story(getActivity(), items);
            recyclerView.setLayoutManager(new GridLayoutManager(getActivity().getApplicationContext(), 2));
            recyclerView.setHasFixedSize(true);
            recyclerView.setAdapter(mAdapter);
            mAdapter.setOnItemClickListener(TabMyVideosStory.this);
            mAdapter.setOnItemLongClickListener(TabMyVideosStory.this);
            checkListSize();
        }
    }
        ...
        public void onClick(DialogInterface dialog, int which) {
            switch (which) {
                case R.styleable.View_android_theme /*0*/:
                    ...
                    Uri screenshotUri = Uri.parse(((DownloadModel_Story) items.get(this.val$selectedPos)).filePath);
                ...
                case R.styleable.View_android_focusable /*1*/:
                    try {
                        createInstagramIntent("video/*", ((DownloadModel_Story) items.get(this.val$selectedPos)).filePath);
                    } catch (Exception e) {
                ...
                case R.styleable.View_paddingStart /*2*/:
                    DialogUtils.showDeleteDialog(Story_view.act, new C04071());
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        this.recyclerView.addItemDecoration(new SpacesItemDecoration_Story(1));
    ...
    private void checkListSize() {
        ...
        this.tvLoading.setText("No Video Story \n" +
                "You have no Video story download");
        this.tvLoading.setVisibility(View.VISIBLE);
    }

    public void onItemClick(int position) {
        this.selectedPos = position;
        String path = ((DownloadModel_Story) this.items.get(position)).filePath;
        Intent itVideo = new Intent(getActivity(), CreatedVideoActivity_Story.class);
    ...
    private void showDialog(int selectedPos) {
        CharSequence[] colors = new CharSequence[]{"Share", "Write for posts", "Remove"};
