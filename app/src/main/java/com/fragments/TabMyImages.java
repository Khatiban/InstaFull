...
public class TabMyImages extends Fragment implements onItemLongClickListener, onItemClickListener {
            ...
            switch (which) {
                ...
                case R.styleable.View_android_focusable /*1*/:
                    try {
                        ...
                        Toast.makeText(TabMyImages.this.getActivity(), "With out Instagram how to Download ?", Toast.LENGTH_LONG).show();
                    }
    ...
    private void checkListSize() {
        ...
        tvLoading.setText("No Image Profile \n" +
                "You have no image Profile download");
    ...
    public void onItemLongClick(int position) {
        ...
        CharSequence[] colors = new CharSequence[]{ "Share friend", "Write for posts", "Remove"};
