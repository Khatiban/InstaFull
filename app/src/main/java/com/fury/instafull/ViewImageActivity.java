...
@TargetApi(21)
public class ViewImageActivity extends AppCompatActivity implements OnPageChangeListener, OnClickListener {
    ...
    private class MyPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(View view, int position) {
            String imgPath = ((DownloadModel) items.get(position)).filePath;
            PhotoView iv = new PhotoView(ViewImageActivity.this);
    ...
    public class deleteSingleFilesAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            TabMyImages.act.removeSingleImageFromViewer(index);
            items.remove(model);
            finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            CharSequence fileName = new File(((DownloadModel) this.items.get(this.index)).filePath).getName();
    ...
    public void onPageScrolled(int arg0, float arg1, int arg2) {
        this.index = arg0;
        try {
            CharSequence fileName = new File(((DownloadModel) items.get(index)).filePath).getName();
            text_name.setText(fileName);
        } catch (Exception e) {
    ...
    public void onClick(View arg0) {
        switch (arg0.getId()) {
            ...
            case R.id.rlExport /*2131165362*/:
                ...
                intent.putExtra("android.intent.extra.STREAM", Uri.fromFile(new File(((DownloadModel) this.items.get(this.index)).filePath)));
            ...
            case R.id.rlDelete2 /*2131165363*/:
                ...
                v2.findViewById(R.id.rlDelete).setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View rippleView) {
                        new deleteSingleFilesAsync(((DownloadModel) ViewImageActivity.this.items.get(ViewImageActivity.this.index)).filePath).execute();
                        d.dismiss();
                    }
                });
            ...
            case R.id.action_repost /*2131165479*/:
                try {
                    createInstagramIntent("image/*", ((DownloadModel) this.items.get(this.index)).filePath);
                    break;
                } catch (Exception e) {
                    FirebaseCrash.report(new Exception("not found insta"));
