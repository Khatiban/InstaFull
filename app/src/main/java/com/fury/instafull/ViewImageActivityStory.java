...
@TargetApi(21)
public class ViewImageActivityStory extends AppCompatActivity implements OnPageChangeListener, OnClickListener {
    public static ViewImageActivityStory act;
    ...
    class C16217 implements OnClickListener {
        ...
        public void onClick(View rippleView) {
            ...
            try {
                ...
                DialogUtils.showUpdateDialog(ViewImageActivityStory.act);
            }
            this.val$d.dismiss();
        }
    }
    ...
    private class MyPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(View view, int position) {
            String imgPath = ((DownloadModel_Story) items.get(position)).filePath;
            PhotoView iv = new PhotoView(ViewImageActivityStory.this);
    ...
    public class deleteSingleFilesAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            this.pd = new ProgressDialog(ViewImageActivityStory.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            TabMyImagesStory.act.removeSingleImageFromViewer(index);
            items.remove(model);
            finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.items = TabMyImagesStory.items;
        ...
        try {
            CharSequence fileName = new File(((DownloadModel_Story) this.items.get(this.index)).filePath).getName();
    ...
    public void onPageScrolled(int arg0, float arg1, int arg2) {
        this.index = arg0;
        try {
            CharSequence fileName = new File(((DownloadModel_Story) items.get(index)).filePath).getName();
            text_name.setText(fileName);
        } catch (Exception e) {
            text_name.setText("");
        }
    ...
    public void onClick(View arg0) {
        switch (arg0.getId()) {
            ...
            case R.id.rlExport /*2131165362*/:
                ...
                intent.putExtra("android.intent.extra.STREAM", Uri.fromFile(new File(((DownloadModel_Story) this.items.get(this.index)).filePath)));
            ...
            case R.id.rlDelete2 /*2131165363*/:
                ...
                v2.findViewById(R.id.rlDelete).setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View rippleView) {
                        new deleteSingleFilesAsync(((DownloadModel_Story) ViewImageActivityStory.this.items.get(ViewImageActivityStory.this.index)).filePath).execute();
                        d.dismiss();
                    }
                });
            ...
            case R.id.action_repost /*2131165479*/:
                try {
                    createInstagramIntent("image/*", ((DownloadModel_Story) this.items.get(this.index)).filePath);
                    break;
                } catch (Exception e) {
                    Toast.makeText(this, "Not Instagram!", Toast.LENGTH_LONG).show();
                    FirebaseCrash.report(new Exception("not found instagram"));
                    break;
                }
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == 215 && resultCode == RESULT_OK && this.doCut) {
            TabMyImagesStory.act.removeSingleImageFromViewer(this.index);
            finish();
        }
