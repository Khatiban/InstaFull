    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        auto_on.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (b) {
                    if (coin_alfa){
                        (new DialogCoinSettingCoin(Setting.this, "Note", "Attention Attention", "After enabling can no longer of internal devices up like watch the video and photo do not have access and ever before opening app Instagram opens and prevent opening Instafull is (Instafull is enabled and download done but pages applications are not shown)", "ON", "Cancel", true, 1000)).showDialog();
                    }else if (coin >= 5000) {
                        (new DialogCoinSettingCoin(Setting.this, "Note", "Attention Attention", "After enabling can no longer of internal devices up like watch the video and photo do not have access and ever before opening app Instagram opens and prevent opening Instafull is (Instafull is enabled and download done but pages applications are not shown)", "ON", "Cancel", true, 1)).showDialog();
                    } else {
                        (new DialogCoinSettingCoin(Setting.this, "Coin is not enough", "To enable 5000 coins need", "To get coins go to the store", "Store", "OK", false, 1)).showDialog();
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    ...
                    if (coin_alfa){
                        ...
                        (new DialogCoinSettingCoin(Setting.this, "Coin is not enough", "To enable 500 coins need", "To get coins go to the store", "Store", "OK", false, 0)).showDialog();
        ...
        name_image_full = "/Internal memory/" + name_image + "/";
        ...
        name_folder_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (coin_alfa){
                    ...
                    (new DialogCoinSettingCoin(Setting.this, "Coin is not enough", "To enable 2000 coins need", "To get coins go to the store", "Store", "OK", false, 0)).showDialog();
                }
            }
        });
        name_video = one_play_preferences.getString("VIDEO_POST", "InstaFull/Video");
        name_video_full = "/Internal memory/" + name_video + "/";
        ...
        name_profile_full = "/Internal memory/"+ name_profile + "/";
        ...
        name_story_image_full = "/Internal memory/"+ name_story_image + "/";
        ...
        name_story_video_full = "/Internal memory/"+ name_story_video + "/";
