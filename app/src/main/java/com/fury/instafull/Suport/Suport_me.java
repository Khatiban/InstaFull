package com.fury.instafull.Suport;
...
import com.fury.instafull.Loading.BernoullisProgressView;
import com.fury.instafull.PageStart.views.FlowingGradientClass;
import com.fury.instafull.R;
import com.fury.instafull.app_net;
...
public class Suport_me extends Activity {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mobile.length() != 11 && email.length() == 0) {
                    ...
                    try {
                        Toast.makeText(getApplicationContext(), "Please information enter your", Toast.LENGTH_LONG).show();
                    } catch (Exception e) {
                    ...
                    try {
                        Toast.makeText(getApplicationContext(), "Name enter your", Toast.LENGTH_LONG).show();
                    } catch (Exception e) {
                    ...
                    FirebaseCrash.report(new Exception("Messege World : " + text_kol));
                        ...
                        new Handler().postDelayed(new Thread() {
                            ...
                            public void run() {
                                ...
                                if (app_net.getInstance(Suport_me.this).isOnline()) {
                                    ...
                                    Toast.makeText(getApplicationContext(), "Send was", Toast.LENGTH_LONG).show();
                                }else {
                                    progress_support.setVisibility(View.GONE);
                                    btn_send.setVisibility(View.VISIBLE);
                                    Toast.makeText(getApplicationContext(),"After contact the internet automatically be sent a message has been saved", Toast.LENGTH_LONG).show();
                                }
                            }
                        }, 2000);
                    } catch (Exception e) {
    ...
    public void generateNoteOnSD(Context context, String sFileName, String sBody) {
        try {
            ...
            root = new File(Environment.getExternalStorageDirectory(), "InstaFull/Support");
            if (!root.exists()) {
                root.mkdirs();
            }
